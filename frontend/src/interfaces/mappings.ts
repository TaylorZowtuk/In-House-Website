...
export function participantToPlayer(participant: ParticipantDTO): PlayerStatDTO {
    return {
        ...
        neutralMinionsKilledEnemyJungle: participant.NEUTRAL_MINIONS_KILLED_ENEMY_JUNGLE,
        neutralMinionsKilledYourJungle: participant.NEUTRAL_MINIONS_KILLED_YOUR_JUNGLE,
        ...
        physicalDamageDealtToChampions: participant.PHYSICAL_DAMAGE_DEALT_TO_CHAMPIONS,
        ...
        totalDamageShieldedOnTeammates: participant.TOTAL_DAMAGE_SHIELDED_ON_TEAMMATES,
